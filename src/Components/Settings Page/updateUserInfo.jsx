...
import submitUpdatedUserDetails from "./Helpers/submitUpdatedUserDetails";
...
export default function UpdateUserInfo() {
  ...
  return (
    <div className=" mt-10 flex flex-col justify-center items-center border-lime-200 text-white m-5 rounded-4xl p-10 bg-zinc-800 border-4">
