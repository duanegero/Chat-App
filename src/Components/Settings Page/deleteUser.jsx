...
export default function DeleteUser() {
  ...
  const handleSubmit = (event) => {
    ...
    submitDeleteUser(navigate, userId);
  };

  return (
    <div className=" mt-10 flex flex-col justify-center items-center border-4 m-5 rounded-4xl p-10 bg-zinc-700 text-red-400 border-red-400">
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex justify-center items-center mt-4">
          <button
            className="border-2 border-red-400 text-red-400 py-2 px-10 rounded-xl text-xl font-goldman cursor-pointer hover:border-white hover:text-white hover:bg-red-500 tracking-wider"
            type="submit"
          >
            DELETE
          </button>
